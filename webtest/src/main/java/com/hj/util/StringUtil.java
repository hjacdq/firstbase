...
public class StringUtil {
    ...
    public static String getShortName(Class clazz) {
        if (clazz != null) return clazz.getName().substring(clazz.getName().lastIndexOf('.') + 1);
        else return null;
    ...
    public static boolean telephoneTest(String number){
    ...
    public static boolean positiveTest(String num){
